...
def test_app_no_longer_uses_mvp_branding_in_visible_header() -> None:
    source = APP_SOURCE.read_text(encoding="utf-8")

    assert 'page_title="Sentinela Industrial"' in source
    assert 'st.title("Sentinela Industrial")' in source
